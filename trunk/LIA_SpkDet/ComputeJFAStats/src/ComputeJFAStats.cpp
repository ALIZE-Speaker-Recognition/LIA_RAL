...
#if !defined(ALIZE_ComputeJFAStats_cpp)
#define ALIZE_ComputeJFAStats_cpp
...
#include "liatools.h"
#include "ComputeJFAStats.h"

using namespace alize;
using namespace std;

int ComputeJFAStats(Config &config){

	String ndxFilename = config.getParam("ndxFilename");
	
	//Creation de l'accumulateur
	JFAAcc jfaAcc(ndxFilename, config, "Accumulate");
